...
ggplot(Data, aes(x = year, y = milk_per_cow)) +
  ...
  theme_minimal() +
  theme(
    plot.background = element_rect(fill = "#f9faeb", color = NA), 
    panel.background = element_rect(fill = "#f9faeb", color = NA), 
    legend.position = "none",
    axis.title.x = element_text(size = 14, color = "#0A0A0A"), 
    axis.title.y = element_text(size = 14, color = "#0A0A0A"), 
    axis.text.x = element_text(size = 12, color = "#0A0A0A"),  
    axis.text.y = element_text(size = 12, color = "#0A0A0A"),  
    axis.ticks = element_line(color = "#0A0A0A")  
    )   
